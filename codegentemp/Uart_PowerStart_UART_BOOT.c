/***************************************************************************//**
* \file Uart_PowerStart_UART_BOOT.c
* \version 4.0
*
* \brief
...
/*******************************************************************************
* Function Name: Uart_PowerStart_UartCyBtldrCommStart
****************************************************************************//**
*
...
{
    Uart_PowerStart_Start();
}


/*******************************************************************************
* Function Name: Uart_PowerStart_UartCyBtldrCommStop
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: Uart_PowerStart_UartCyBtldrCommReset
****************************************************************************//**
*
...
void Uart_PowerStart_UartCyBtldrCommReset(void)
{
    ...
    Uart_PowerStart_SpiUartClearRxBuffer();
    Uart_PowerStart_SpiUartClearTxBuffer();
}


/*******************************************************************************
* Function Name: Uart_PowerStart_UartCyBtldrCommRead
****************************************************************************//**
*
    ...
    if ((NULL != pData) && (size > 0u))
    {
        ...
        do
        {
            ...
            if (0u != Uart_PowerStart_SpiUartGetRxBufferSize())
            {
                ...
                do
                {
                    byteCount = Uart_PowerStart_SpiUartGetRxBufferSize();
                    CyDelayUs(Uart_PowerStart_UART_BYTE_TO_BYTE);
                }
                while (byteCount != Uart_PowerStart_SpiUartGetRxBufferSize());

                byteCount = Uart_PowerStart_BYTES_TO_COPY(byteCount, size);
            ...
            CyDelay(Uart_PowerStart_WAIT_1_MS);
            --timeoutMs;
        }
        while (0u != timeoutMs);
        ...
        {
            pData[i] = (uint8) Uart_PowerStart_SpiUartReadRxData();
        }
    }
...
/*******************************************************************************
* Function Name: Uart_PowerStart_UartCyBtldrCommWrite
****************************************************************************//**
*
...
cystatus Uart_PowerStart_UartCyBtldrCommWrite(const uint8 pData[], uint16 size, uint16 * count, uint8 timeOut)
{
    ...
    if ((NULL != pData) && (size > 0u))
    {
        ...
        Uart_PowerStart_SpiUartPutArray(pData, (uint32) size);
