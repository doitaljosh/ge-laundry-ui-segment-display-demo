// ======================================================================
// laundry-captouch-demo.v generated from TopDesign.cysch
// 05/22/2021 at 19:45
...
module SCB_P4_v4_0_0 (
	...
	cy_psoc3_pins_v1_10
		#(.id("1d1ecfa9-8ceb-4521-b5e9-b1808ed1a213/23b8206d-1c77-4e61-be4a-b4037d5de5fc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("1d1ecfa9-8ceb-4521-b5e9-b1808ed1a213/78e33e5d-45ea-4b75-88d5-73274e8a7ce4"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module CapSense_P4_v7_0_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("8dff6076-3849-46f0-97b0-ab5b6f39661f/77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_clk_en(0),
		  .input_sync(13'b0_0_0_0_0_0_0_0_0_0_0_0_0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8dff6076-3849-46f0-97b0-ab5b6f39661f/7850aeaf-db25-4eae-b828-015ef596b59e"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
// SCB_P4_v4_0(ApplySbClockParam=false, BitWidthReplacementStringRx=uint8, BitWidthReplacementStringTx=uint8, BufNum=1, Cond=#, DBGW_SCB_IP_V0=false, DBGW_SCB_IP_V1=false, DBGW_SCB_IP_V2=true, DW_Hide_i2c=true, DW_Hide_Scbv0Feature=true, DW_Hide_Scbv2Feature=false, DW_Hide_Spi=true, DW_Hide_Uart=false, DW_Hide_UartFlowControl=false, DW_INTR_SPI_EC=, DW_INTR_SPI_EC_MASK=, DW_INTR_SPI_EC_MASKED=, DW_SPI_CTRL=, DW_SPI_STATUS=, DW_UART_CTRL=Uart_PowerStart_SCB__UART_CTRL, DW_UART_FLOW_CTRL=Uart_PowerStart_SCB__UART_FLOW_CTRL, DW_UART_RX_CTRL=Uart_PowerStart_SCB__UART_RX_CTRL, DW_UART_TX_CTRL=Uart_PowerStart_SCB__UART_TX_CTRL, EndCond=#endif, EzI2cBitWidthReplacementString=uint16, EzI2cBusVoltage=3.3, EzI2cByteModeEnable=false, EzI2cClkFreqDes=1550, EzI2cClockFromTerm=false, EzI2cClockStretching=true, EzI2cDataRate=100, EzI2cIsPrimarySlaveAddressHex=true, EzI2cIsSecondarySlaveAddressHex=true, EzI2cMedianFilterEnable=true, EzI2cNumberOfAddresses=0, EzI2cOvsFactor=16, EzI2cPrimarySlaveAddress=8, EzI2cSecondarySlaveAddress=9, EzI2cShowTerminals=false, EzI2cSlaveAddressMask=254, EzI2cSlewRate=0, EzI2cSubAddressSize=0, EzI2cWakeEnable=false, I2cAcceptAddress=false, I2cAcceptGeneralCall=false, I2cBusVoltage=3.3, I2cBusVoltageLevel=, I2cByteModeEnable=false, I2cClkFreqDes=1550, I2cClockFromTerm=false, I2cDataRate=100, I2cExternIntrHandler=false, I2cIsSlaveAddressHex=true, I2cIsSlaveAddressMaskHex=true, I2cManualOversampleControl=true, I2cMedianFilterEnable=true, I2cMode=1, I2cOvsFactor=16, I2cOvsFactorHigh=8, I2cOvsFactorLow=8, I2cShowTerminals=false, I2cSlaveAddress=8, I2cSlaveAddressMask=254, I2cSlewRate=0, I2cSlewRateSettings=0, I2cTermsEnable=false, I2cWakeEnable=false, PinLocationP4A=true, PinName0Unconfig=uart_rx_i2c_scl_spi_mosi, PinName0UnconfigWake=uart_rx_wake_i2c_scl_spi_mosi, PinName1Unconfig=uart_tx_i2c_sda_spi_miso, PinName2Unconfig=uart_cts_spi_sclk, PinName3Unconfig=uart_rts_spi_ss0, Pn0Unconfig=RX_SCL_MOSI, Pn0UnconfigWake=RX_WAKE_SCL_MOSI, Pn1Unconfig=TX_SDA_MISO, Pn2Unconfig=CTS_SCLK, Pn3Unconfig=RTS_SS0, RemoveI2cPins=true, RemoveMisoSdaTx=true, RemoveMosiSclRx=true, RemoveMosiSclRxWake=true, RemoveScbClk=false, RemoveScbIrq=false, RemoveSpiMasterMiso=true, RemoveSpiMasterMosi=true, RemoveSpiMasterPins=true, RemoveSpiMasterSclk=true, RemoveSpiMasterSs0Pin=true, RemoveSpiMasterSs1Pin=true, RemoveSpiMasterSs2Pin=true, RemoveSpiMasterSs3Pin=true, RemoveSpiSclk=true, RemoveSpiSlaveMiso=true, RemoveSpiSlaveMosi=true, RemoveSpiSlavePins=true, RemoveSpiSs0=true, RemoveSpiSs1=true, RemoveSpiSs2=true, RemoveSpiSs3=true, RemoveUartCtsPin=true, RemoveUartRtsPin=true, RemoveUartRxPin=false, RemoveUartRxTxPin=true, RemoveUartRxWake=true, RemoveUartRxWakeupIrq=true, RemoveUartTxPin=false, RxTriggerOutputEnable=false, ScbClkFreqDes=2995.2, ScbClkMinusTolerance=5, ScbClkPlusTolerance=5, ScbClockSelect=1, ScbClockTermEnable=false, ScbCustomIntrHandlerEnable=true, ScbInterruptTermEnable=false, ScbMisoSdaTxEnable=true, ScbMode=4, ScbModeHw=2, ScbMosiSclRxEnable=true, ScbRxWakeIrqEnable=false, ScbSclkEnable=false, ScbSs0Enable=false, ScbSs1Enable=false, ScbSs2Enable=false, ScbSs3Enable=false, ScbSymbolVisibility=0, SpiBitRate=1000, SpiBitsOrder=1, SpiByteModeEnable=false, SpiClkFreqDes=16000, SpiClockFromTerm=false, SpiFreeRunningSclk=false, SpiInterruptMode=0, SpiIntrMasterSpiDone=false, SpiIntrRxFull=false, SpiIntrRxNotEmpty=false, SpiIntrRxOverflow=false, SpiIntrRxTrigger=false, SpiIntrRxUnderflow=false, SpiIntrSlaveBusError=false, SpiIntrTxEmpty=false, SpiIntrTxNotFull=false, SpiIntrTxOverflow=false, SpiIntrTxTrigger=false, SpiIntrTxUnderflow=false, SpiLateMisoSampleEnable=false, SpiManualOversampleControl=true, SpiMasterMode=false, SpiMedianFilterEnable=false, SpimMisoTermEnable=false, SpimMosiTermEnable=false, SpiMode=0, SpimSclkTermEnable=false, SpimSs0TermEnable=false, SpimSs1TermEnable=false, SpimSs2TermEnable=false, SpimSs3TermEnable=false, SpiNumberOfRxDataBits=8, SpiNumberOfSelectLines=1, SpiNumberOfTxDataBits=8, SpiOvsFactor=16, SpiRemoveMiso=false, SpiRemoveMosi=false, SpiRemoveSclk=false, SpiRxBufferSize=8, SpiRxIntrMask=0, SpiRxOutputEnable=false, SpiRxTriggerLevel=7, SpiSclkMode=0, SpiSlaveMode=false, SpiSmartioEnable=false, SpisMisoTermEnable=false, SpisMosiTermEnable=false, SpiSs0Polarity=0, SpiSs1Polarity=0, SpiSs2Polarity=0, SpiSs3Polarity=0, SpisSclkTermEnable=false, SpisSsTermEnable=false, SpiSubMode=0, SpiTransferSeparation=1, SpiTxBufferSize=8, SpiTxIntrMask=0, SpiTxOutputEnable=false, SpiTxTriggerLevel=0, SpiWakeEnable=false, TriggerOutputEnable=false, TxTriggerOutputEnable=false, UartByteModeEnable=false, UartClkFreqDes=2995.2, UartClockFromTerm=false, UartCtsEnable=false, UartCtsPolarity=0, UartCtsTermEnable=false, UartDataRate=230400, UartDirection=3, UartDropOnFrameErr=false, UartDropOnParityErr=false, UartInterruptMode=1, UartIntrRxBreakDetected=false, UartIntrRxFrameErr=false, UartIntrRxFull=false, UartIntrRxNotEmpty=true, UartIntrRxOverflow=false, UartIntrRxParityErr=false, UartIntrRxTrigger=false, UartIntrRxUnderflow=false, UartIntrTxEmpty=false, UartIntrTxNotFull=false, UartIntrTxOverflow=false, UartIntrTxTrigger=false, UartIntrTxUartDone=true, UartIntrTxUartLostArb=false, UartIntrTxUartNack=false, UartIntrTxUnderflow=false, UartIrdaLowPower=false, UartIrdaPolarity=0, UartMedianFilterEnable=false, UartMpEnable=false, UartMpRxAcceptAddress=false, UartMpRxAddress=2, UartMpRxAddressMask=255, UartNumberOfDataBits=8, UartNumberOfStopBits=2, UartOvsFactor=13, UartParityType=2, UartRtsEnable=false, UartRtsPolarity=0, UartRtsTermEnable=false, UartRtsTriggerLevel=4, UartRxBreakWidth=11, UartRxBufferSize=16, UartRxEnable=true, UartRxIntrMask=4, UartRxOutputEnable=false, UartRxTermEnable=false, UartRxTriggerLevel=7, UartRxTxTermEnable=false, UartSmartioEnable=false, UartSmCardRetryOnNack=false, UartSubMode=0, UartTxBufferSize=16, UartTxEnable=true, UartTxIntrMask=512, UartTxOutputEnable=false, UartTxTermEnable=false, UartTxTriggerLevel=0, UartWakeEnable=false, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=SCB_P4_v4_0, CY_CONFIG_TITLE=Uart_PowerStart, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Uart_PowerStart, CY_INSTANCE_SHORT_NAME=Uart_PowerStart, CY_MAJOR_VERSION=4, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Uart_PowerStart, )
...
module top ;
    ...
    CapSense_P4_v7_0_1 Input_Capsense ();

    SCB_P4_v4_0_2 Uart_PowerStart (
        .clock(1'b0),
        .cts_in(1'b0),
        .interrupt(Net_1613),
        .m_miso(1'b0),
	...
	wire [0:0] tmpOE__SegDispStb1_net;
	wire [0:0] tmpFB_0__SegDispStb1_net;
	wire [0:0] tmpIO_0__SegDispStb1_net;
	wire [0:0] tmpINTERRUPT_0__SegDispStb1_net;
	electrical [0:0] tmpSIOVREF__SegDispStb1_net;

	cy_psoc3_pins_v1_10
		#(.id("991d2c21-051d-440f-aff6-757a12bfc084"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SegDispStb1
		 (.oe(tmpOE__SegDispStb1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SegDispStb1_net[0:0]}),
		  .io({tmpIO_0__SegDispStb1_net[0:0]}),
		  .siovref(tmpSIOVREF__SegDispStb1_net),
		  .interrupt({tmpINTERRUPT_0__SegDispStb1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SegDispStb1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SegDispClock_net;
	wire [0:0] tmpFB_0__SegDispClock_net;
	wire [0:0] tmpIO_0__SegDispClock_net;
	wire [0:0] tmpINTERRUPT_0__SegDispClock_net;
	electrical [0:0] tmpSIOVREF__SegDispClock_net;

	cy_psoc3_pins_v1_10
		#(.id("9ff96873-2758-475c-8980-82f2d118082a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SegDispClock
		 (.oe(tmpOE__SegDispClock_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SegDispClock_net[0:0]}),
		  .io({tmpIO_0__SegDispClock_net[0:0]}),
		  .siovref(tmpSIOVREF__SegDispClock_net),
		  .interrupt({tmpINTERRUPT_0__SegDispClock_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SegDispClock_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SegDispData_net;
	wire [0:0] tmpFB_0__SegDispData_net;
	wire [0:0] tmpIO_0__SegDispData_net;
	wire [0:0] tmpINTERRUPT_0__SegDispData_net;
	electrical [0:0] tmpSIOVREF__SegDispData_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		SegDispData
		 (.oe(tmpOE__SegDispData_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SegDispData_net[0:0]}),
		  .io({tmpIO_0__SegDispData_net[0:0]}),
		  .siovref(tmpSIOVREF__SegDispData_net),
		  .interrupt({tmpINTERRUPT_0__SegDispData_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SegDispData_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SelectorKnobData_net;
	wire [0:0] tmpFB_0__SelectorKnobData_net;
	wire [0:0] tmpIO_0__SelectorKnobData_net;
	wire [0:0] tmpINTERRUPT_0__SelectorKnobData_net;
	electrical [0:0] tmpSIOVREF__SelectorKnobData_net;

	cy_psoc3_pins_v1_10
		#(.id("0fcd3a42-f956-44f7-8135-ff4043250f67"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SelectorKnobData
		 (.oe(tmpOE__SelectorKnobData_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SelectorKnobData_net[0:0]}),
		  .io({tmpIO_0__SelectorKnobData_net[0:0]}),
		  .siovref(tmpSIOVREF__SelectorKnobData_net),
		  .interrupt({tmpINTERRUPT_0__SelectorKnobData_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SelectorKnobData_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SegDispStb2_net;
	wire [0:0] tmpFB_0__SegDispStb2_net;
	wire [0:0] tmpIO_0__SegDispStb2_net;
	wire [0:0] tmpINTERRUPT_0__SegDispStb2_net;
	electrical [0:0] tmpSIOVREF__SegDispStb2_net;

	cy_psoc3_pins_v1_10
		#(.id("94090a8b-7d23-4c1d-889e-81af93c15989"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SegDispStb2
		 (.oe(tmpOE__SegDispStb2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SegDispStb2_net[0:0]}),
		  .io({tmpIO_0__SegDispStb2_net[0:0]}),
		  .siovref(tmpSIOVREF__SegDispStb2_net),
		  .interrupt({tmpINTERRUPT_0__SegDispStb2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SegDispStb2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__EncoderSink_net;
	wire [0:0] tmpFB_0__EncoderSink_net;
	wire [0:0] tmpIO_0__EncoderSink_net;
	wire [0:0] tmpINTERRUPT_0__EncoderSink_net;
	electrical [0:0] tmpSIOVREF__EncoderSink_net;

	cy_psoc3_pins_v1_10
		#(.id("26272c0a-0e51-4756-b21c-efde39014229"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		EncoderSink
		 (.oe(tmpOE__EncoderSink_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__EncoderSink_net[0:0]}),
		  .io({tmpIO_0__EncoderSink_net[0:0]}),
		  .siovref(tmpSIOVREF__EncoderSink_net),
		  .interrupt({tmpINTERRUPT_0__EncoderSink_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__EncoderSink_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__BuzzerFreq_net;
	wire [0:0] tmpFB_0__BuzzerFreq_net;
	wire [0:0] tmpIO_0__BuzzerFreq_net;
	wire [0:0] tmpINTERRUPT_0__BuzzerFreq_net;
	electrical [0:0] tmpSIOVREF__BuzzerFreq_net;

	cy_psoc3_pins_v1_10
		#(.id("66e77d39-c97d-4697-b545-ef894b92a267"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		BuzzerFreq
		 (.oe(tmpOE__BuzzerFreq_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BuzzerFreq_net[0:0]}),
		  .io({tmpIO_0__BuzzerFreq_net[0:0]}),
		  .siovref(tmpSIOVREF__BuzzerFreq_net),
		  .interrupt({tmpINTERRUPT_0__BuzzerFreq_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BuzzerFreq_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__BuzzerVol_net;
	wire [0:0] tmpFB_0__BuzzerVol_net;
	wire [0:0] tmpIO_0__BuzzerVol_net;
	wire [0:0] tmpINTERRUPT_0__BuzzerVol_net;
	electrical [0:0] tmpSIOVREF__BuzzerVol_net;

	cy_psoc3_pins_v1_10
		#(.id("67d2fefb-56b4-42a8-87bc-0b5e88d33a2b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		BuzzerVol
		 (.oe(tmpOE__BuzzerVol_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BuzzerVol_net[0:0]}),
		  .io({tmpIO_0__BuzzerVol_net[0:0]}),
		  .siovref(tmpSIOVREF__BuzzerVol_net),
		  .interrupt({tmpINTERRUPT_0__BuzzerVol_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BuzzerVol_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SelectorKnobOE_net;
	wire [0:0] tmpFB_0__SelectorKnobOE_net;
	wire [0:0] tmpIO_0__SelectorKnobOE_net;
	wire [0:0] tmpINTERRUPT_0__SelectorKnobOE_net;
	electrical [0:0] tmpSIOVREF__SelectorKnobOE_net;

	cy_psoc3_pins_v1_10
		#(.id("f2a76bba-0d87-4af7-8506-dca00af547c2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SelectorKnobOE
		 (.oe(tmpOE__SelectorKnobOE_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SelectorKnobOE_net[0:0]}),
		  .io({tmpIO_0__SelectorKnobOE_net[0:0]}),
		  .siovref(tmpSIOVREF__SelectorKnobOE_net),
		  .interrupt({tmpINTERRUPT_0__SelectorKnobOE_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SelectorKnobOE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SelectorKnobLE_net;
	wire [0:0] tmpFB_0__SelectorKnobLE_net;
	wire [0:0] tmpIO_0__SelectorKnobLE_net;
	wire [0:0] tmpINTERRUPT_0__SelectorKnobLE_net;
	electrical [0:0] tmpSIOVREF__SelectorKnobLE_net;

	cy_psoc3_pins_v1_10
		#(.id("87aac201-621c-4859-b25d-9e2e9139a0a5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SelectorKnobLE
		 (.oe(tmpOE__SelectorKnobLE_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SelectorKnobLE_net[0:0]}),
		  .io({tmpIO_0__SelectorKnobLE_net[0:0]}),
		  .siovref(tmpSIOVREF__SelectorKnobLE_net),
		  .interrupt({tmpINTERRUPT_0__SelectorKnobLE_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SelectorKnobLE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SelectorKnobClock_net;
	wire [0:0] tmpFB_0__SelectorKnobClock_net;
	wire [0:0] tmpIO_0__SelectorKnobClock_net;
	wire [0:0] tmpINTERRUPT_0__SelectorKnobClock_net;
	electrical [0:0] tmpSIOVREF__SelectorKnobClock_net;

	cy_psoc3_pins_v1_10
		#(.id("98e7aa50-c0d0-4902-8ea7-27d8a895e42d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SelectorKnobClock
		 (.oe(tmpOE__SelectorKnobClock_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SelectorKnobClock_net[0:0]}),
		  .io({tmpIO_0__SelectorKnobClock_net[0:0]}),
		  .siovref(tmpSIOVREF__SelectorKnobClock_net),
		  .interrupt({tmpINTERRUPT_0__SelectorKnobClock_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SelectorKnobClock_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__HeartbeatLed_net;
	wire [0:0] tmpFB_0__HeartbeatLed_net;
	wire [0:0] tmpIO_0__HeartbeatLed_net;
	wire [0:0] tmpINTERRUPT_0__HeartbeatLed_net;
	electrical [0:0] tmpSIOVREF__HeartbeatLed_net;

	cy_psoc3_pins_v1_10
		#(.id("184e2f13-5093-49f9-9c56-6d5b6caef093"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		HeartbeatLed
		 (.oe(tmpOE__HeartbeatLed_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__HeartbeatLed_net[0:0]}),
		  .io({tmpIO_0__HeartbeatLed_net[0:0]}),
		  .siovref(tmpSIOVREF__HeartbeatLed_net),
		  .interrupt({tmpINTERRUPT_0__HeartbeatLed_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HeartbeatLed_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
